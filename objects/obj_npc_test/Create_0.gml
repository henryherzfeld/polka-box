...
questions[| 1] = [enum_question_type.evidence_multi, "Prompt evi_multi", ["Right", "Wrong", "Wrong"], [enum_evi_type.evidence2, 0], [["right! you're so awesome and funny"], ["wrong idiot"]]];
questions[| 2] = [enum_question_type.multi, "Prompt multi", ["Right", "Wrong", "Wrong"], 0, [["Correct!!!!!"]]];
questions[| 3] = [enum_question_type.checkbox, "Prompt checkbox", ["Right", "Wrong", "Right", "Right"], [0, 2, 3], []];
