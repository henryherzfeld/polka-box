...
questions[| 0] = [enum_question_type.multi, "Prompt multi", ["Right", "Wrong", "Wrong"], 0, [["Correct!!!!!"]]];
...
text[? "GREET"] =	[["Hey I'm ready for the quiz!", ["SPRITE", spr_textbox]], ["Okay here goes sucka", ["SPRITE", spr_textbox]],
