...
scr_grid_add_button([500, 500], [200, 300], ["debug on", "debug off"], enum_button_type.radio, enum_button_event.run_script, [[scr_change_variable, game.id, "debug", true], [scr_change_variable, game.id, "debug", false]]);
