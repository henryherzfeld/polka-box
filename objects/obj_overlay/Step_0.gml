...
switch(flags.objective_phase){
	case enum_objective_phase.miscellaneous: {objective_col = c_navy; objective_text_col = c_black; break;}
	...
	case enum_objective_phase.analyze_clues: {objective_col= c_gray; objective_text_col = c_white; break;}
}