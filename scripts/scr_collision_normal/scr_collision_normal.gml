///@description collision_normal(x1,y1,obj [,rad [,res]])
function scr_collision_normal() {
	...
	//
	//@arg0 x1       point on the surface, real
	//@arg1 y1
	//@arg2 obj         object or instance (or all), real
	//@arg3 rad         radius of test area (default 4), real
	//@arg4 res         resolution of test (default 1), real
	//
