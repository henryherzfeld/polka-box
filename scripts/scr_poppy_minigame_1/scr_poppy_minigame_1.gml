function scr_poppy_minigame_1() {
	...
	scr_dia_line("I wasn't the most popular girl at my school." , obj_npc_poppy); 
	...
	*/
	...
	scene_info = [
		...
		[scr_cutscene_move_character, obj_npc_poppy, 32, 0, true, 0.6],
		...
		[scr_cutscene_move_character, obj_npc_poppy, 0, 48, true, 0.6],
		[scr_cutscene_move_character, obj_npc_poppy, 51, 0, true, 0.6],
		[scr_cutscene_move_character, obj_npc_poppy, 0, -48, true, 0.6],
		[scr_cutscene_move_character_facing, obj_npc_poppy, 400, 50, false, 0.6, dir.right],
		[scr_cutscene_wait, .25],
		...
		[scr_cutscene_move_character, obj_npc_poppy, 51, 0, true, 0.6],
		[scr_cutscene_move_character, obj_npc_poppy, 0, -48, true, 0.6],
		[scr_cutscene_move_character_facing, obj_npc_poppy, 450, 50, false, 0.6, dir.right],
		[scr_cutscene_wait, .25],
		...
		//polka sits in chair
		[scr_cutscene_move_character, polka, 0, -36, true, 0.7],
		[scr_cutscene_move_character, polka, -124, 0, true, 0.7],
		...
		[scr_cutscene_move_character, obj_npc_poppy, 0, 48, true, 0.7],
		[scr_cutscene_move_character, obj_npc_poppy, 295, 113, false, 0.7],
		[scr_cutscene_wait, .5],
		[scr_cutscene_change_facing, obj_npc_poppy, dir.down],
		[scr_cutscene_wait, .5],
		...
		[scr_cutscene_move_character, obj_npc_poppy, 72, 0, true, 0.7],
		[scr_cutscene_move_character_facing, obj_npc_poppy, 360, 130, false, 0.7, dir.down],
		...
		[scr_cutscene_move_character, obj_npc_poppy, 12, 24, true, .7],
		...
		[scr_cutscene_move_character, obj_npc_poppy, 48, 0, true, .7],
		...
		[scr_cutscene_change_room_fade, second_village, 337, 1307, .1],
		[scr_cutscene_wait, 1],
	
		[scr_cutscene_change_facing, polka, dir.up],
		[scr_cutscene_wait, 1],
		[scr_cutscene_change_facing, polka, dir.down],	
